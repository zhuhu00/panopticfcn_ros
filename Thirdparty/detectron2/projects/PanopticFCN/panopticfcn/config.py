...
def add_panopticfcn_config(cfg):
    ...
    cfg.MODEL.POSITION_HEAD.THING.POS_NUM        = 3
    ...
    cfg.MODEL.POSITION_HEAD.THING.THRES          = 0.2
    ...
    cfg.MODEL.POSITION_HEAD.STUFF.THRES        = 0.1
    ...
    cfg.MODEL.META_ARCHITECTURE =  "PanopticFCN"
    ...
    cfg.MODEL.WEIGHTS = "a.pth"

    cfg.SOLVER.BASE_LR= 0.01

    cfg.INPUT.MIN_SIZE_TRAIN = (352, 384, 416, 448, 480, 512)
    cfg.INPUT.MIN_SIZE_TRAIN_SAMPLING= "choice"
    cfg.INPUT.MIN_SIZE_TEST= 512
    cfg.INPUT.MAX_SIZE_TRAIN= 854
    cfg.INPUT.MAX_SIZE_TEST= 854
    cfg.INPUT.MASK_FORMAT= "bitmask"
    cfg.DATASETS.TRAIN = ("coco_2017_train_panoptic_separated",)
    cfg.DATASETS.TEST = ("coco_2017_val_panoptic_separated",)
